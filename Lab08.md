...
> [!caution]
> lease use PyCharm to provide "http://" or `python -m http.server`. By using the "file://" protocol you'll get [CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CORS) errors that will make the applicaton fail.
