...
* [Task 7.2: Observability using Elastic and Kibana](#Task72)
...
## Task 7.2: Observability using Elastic and Kibana
...
for log aggregation, analysis, and visualization. At this point, you shall have access to your 14-day trial.
...
The formatter obtains the `basic` configuration parameter and uses them to extract some of the logger library default
fields such as the timestamp, function, module, ... explained in laboratory session 6. The `extra` configuration
parameter includes additional record fields to be added to each log.
