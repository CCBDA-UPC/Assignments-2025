...
> :question: **Question 5.3**: Create a screen capture of your DyanmoDB table with the data of the new leads. Add your thoughts on the above
tasks.
...
> :question: **Question 5.4**: Has everything gone alright? Share your thoughts on the task developed above.
...
> :question: **Question 5.5**: Has everything gone alright? Share your thoughts on the task developed above.
...
> :question: **Question 5.6**: Share your thoughts on the task developed above.
...
> :question: **Question 5.7**: For the above lab session, explain, one by one, how each factor is taken into 
